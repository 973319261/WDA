 ...
 * Vin转Esk页面
 */
public class VinEskActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        myActivity=this;
        setContentView(R.layout.activity_vin_esk);
        ...
        tvEsk=findViewById(R.id.tv_security_esk);
        btnCalculate=findViewById(R.id.btn_calculate);
        myActionBar = findViewById(R.id.myActionBar);
        myActionBar.setData(getResources().getString(R.string.text_security_vin_esk_title), R.drawable.ic_back,0,
    ...
    private void setViewListener(){
        ...
        llVehicle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (vehicleList==null){
                    ...
                    map.put("algorithmType",3);//算法类型（类型3）
                                        ...
                                        try {
                                            ...
                                            if (code==200){
                                                ...
                                                if (!isHistory) {//不是历史记录进来的
                                                    ...
                                                    securityRecordVo.setTypeId(3);//设置类型ID
                                                    securityRecordVo.setModuleName("ESK");
                                                    securityRecordVo.setSupplierName("None");
                                                    securityRecordVo.setTypeName(getResources().getString(R.string.text_security_vin_esk_title));//设置类型
                                                ...
                                                // 从后往前每隔4位插入逗号
                                                int last = str.length();
                                                for(int i = last - 4; i > 0; i-=4) {
                                                    str.insert(i,',');
                                                }
                                                tvEsk.setText(str);//设置返回值
        ...
        etVin.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                tvEsk.setText("");//清空输出key
                btnCalculate.setText(R.string.text_security_calculate);//计算
            }
        });
        //输出框长按事件
        tvEsk.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                String key=tvEsk.getText().toString();
